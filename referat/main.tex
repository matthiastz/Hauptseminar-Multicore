...
%       \includegraphics[width=0.23\textwidth]{bilder/stencil}
%   \end{wrapfigure}
%    
%   
%   \text{}
...
%    \textbf{Stencil}
%    \begin{itemize}
%      \item Implementierung von compute kernels
%      \item Anordnung von Elementen in festen Muster (Stencil)
%      \item Verwendung in Simulationen, Differentialgleichung
%     \end{itemize}
...
\begin{frame}
  ...
  \normalsize
  \bibitem{stencil} \url{en.wikipedia.org/wiki/Stencil_code} \footnotesize (08.01.2017)
