...
\end{itemize}
Die Umsetzung geschieht mitteils einem Python-Programm, weil so die direkte Schnittstelle
zu OpenTuner spezifiziert ist. \newline
...
\end{itemize}
Um die eigentliche Übersetzung mit einem Compiler ausführen zu können, sind konkrete
