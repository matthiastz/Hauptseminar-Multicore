...
war bereits der erste erfolgreiche Durchlauf zu verzeichnen. \newline
...
\bibitem{atlas} R. C. Whaley and J. J. Dongarra, \textquotedblleft Automatically tuned linear 
algebra software,\textquotedblright~in \emph{Supercomputing}, Washington, DC, 1998.

\bibitem{fftw} M. Frigo and S. G. Johnson, \textquotedblleft The design and implementation of 
FFTW3,\textquotedblright~\emph{IEEE}, vol. 93, no. 2, February 2005.

\bibitem{fftc} S. Woo, M. Ohara, E. Torrie, J. Singh, and A. Gupta, 
...
\bibitem{mmcpp}  X. Fan, \textquotedblleft Optimize your code:  Matrix multiplication,\textquotedblright~
\url{https://tinyurl.com/kuvzbp9}, 2009.

\bibitem{hpl} J. J. Dongarra, P. Luszczek, and A. Petitet, 
