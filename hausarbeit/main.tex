...
\bibitem{atlas} \url{http://math-atlas.sourceforge.net/}

\bibitem{fftw} \url{http://www.fftw.org/}
    
\bibitem{mmcpp}  X. Fan, \textquotedblleft Optimize your code:  Matrix multiplication,\textquotedblright{}
\url{https://blogs.msdn.microsoft.com/xiangfan/2009/04/28/optimize-your-code-matrix-multiplication}, 2009.

\bibitem{hpl} \url{http://www.netlib.org/benchmark/hpl/}

\bibitem{top500}  Top500,
\textquotedblleft Top 500 supercomputer sites,\textquotedblright~
\url{www.top500.org}, 2010.

\bibitem{petab}  \url{http://projects.csail.mit.edu/petabricks/}

\bibitem{halide} \url{http://halide-lang.org/}
